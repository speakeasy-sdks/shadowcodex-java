...
public class Search {
    ...
    public shadowcodex.slack_spec.models.operations.SearchMessagesResponse searchMessages(shadowcodex.slack_spec.models.operations.SearchMessagesRequest request, shadowcodex.slack_spec.models.operations.SearchMessagesSecurity security) throws Exception {
        String baseUrl = this._serverUrl;
        String url = shadowcodex.slack_spec.utils.Utils.generateURL(baseUrl, "/search.messages");
        
        HTTPRequest req = new HTTPRequest();
        req.setMethod("GET");
        req.setURL(url);
        
        java.util.List<NameValuePair> queryParams = shadowcodex.slack_spec.utils.Utils.getQueryParams(shadowcodex.slack_spec.models.operations.SearchMessagesRequest.class, request, null);
        if (queryParams != null) {
        ...
        shadowcodex.slack_spec.models.operations.SearchMessagesResponse res = new shadowcodex.slack_spec.models.operations.SearchMessagesResponse(contentType, httpRes.statusCode()) {{
