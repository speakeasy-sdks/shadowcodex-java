...
public class AdminInviteRequestsApproved {
	...
	public AdminInviteRequestsApproved(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
