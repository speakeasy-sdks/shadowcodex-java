...
public class Oauth {
    ...
    public shadowcodex.slack_spec.models.operations.OauthAccessResponse oauthAccess(shadowcodex.slack_spec.models.operations.OauthAccessRequest request, shadowcodex.slack_spec.models.operations.OauthAccessSecurity security) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = shadowcodex.slack_spec.utils.Utils.getQueryParams(shadowcodex.slack_spec.models.operations.OauthAccessRequest.class, request, null);
        if (queryParams != null) {
        ...
        shadowcodex.slack_spec.models.operations.OauthAccessResponse res = new shadowcodex.slack_spec.models.operations.OauthAccessResponse(contentType, httpRes.statusCode()) {{
    ...
    public shadowcodex.slack_spec.models.operations.OauthTokenResponse oauthToken(shadowcodex.slack_spec.models.operations.OauthTokenRequest request, shadowcodex.slack_spec.models.operations.OauthTokenSecurity security) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = shadowcodex.slack_spec.utils.Utils.getQueryParams(shadowcodex.slack_spec.models.operations.OauthTokenRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        shadowcodex.slack_spec.models.operations.OauthTokenResponse res = new shadowcodex.slack_spec.models.operations.OauthTokenResponse(contentType, httpRes.statusCode()) {{
            defaultSuccessTemplate = null;
            defaultErrorTemplate = null;
        }};
        res.rawResponse = httpRes;
    ...
    public shadowcodex.slack_spec.models.operations.OauthV2AccessResponse oauthV2Access(shadowcodex.slack_spec.models.operations.OauthV2AccessRequest request, shadowcodex.slack_spec.models.operations.OauthV2AccessSecurity security) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = shadowcodex.slack_spec.utils.Utils.getQueryParams(shadowcodex.slack_spec.models.operations.OauthV2AccessRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        shadowcodex.slack_spec.models.operations.OauthV2AccessResponse res = new shadowcodex.slack_spec.models.operations.OauthV2AccessResponse(contentType, httpRes.statusCode()) {{
            defaultSuccessTemplate = null;
            defaultErrorTemplate = null;
        }};
        res.rawResponse = httpRes;
