...
public class AdminConversationsEkm {
	...
	public AdminConversationsEkm(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
