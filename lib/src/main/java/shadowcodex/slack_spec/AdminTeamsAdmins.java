...
public class AdminTeamsAdmins {
	...
	public AdminTeamsAdmins(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
