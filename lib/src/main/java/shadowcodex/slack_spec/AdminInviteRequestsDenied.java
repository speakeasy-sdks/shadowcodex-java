...
public class AdminInviteRequestsDenied {
	...
	public AdminInviteRequestsDenied(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
