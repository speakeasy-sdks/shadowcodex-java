...
public class Migration {
	...
	public Migration(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public shadowcodex.slack_spec.models.operations.MigrationExchangeResponse migrationExchange(shadowcodex.slack_spec.models.operations.MigrationExchangeRequest request, shadowcodex.slack_spec.models.operations.MigrationExchangeSecurity security) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = shadowcodex.slack_spec.utils.Utils.getQueryParams(shadowcodex.slack_spec.models.operations.MigrationExchangeRequest.class, request, null);
        if (queryParams != null) {
        ...
        shadowcodex.slack_spec.models.operations.MigrationExchangeResponse res = new shadowcodex.slack_spec.models.operations.MigrationExchangeResponse(contentType, httpRes.statusCode()) {{
            migrationExchangeSuccessSchema = null;
            migrationExchangeErrorSchema = null;
        }};
