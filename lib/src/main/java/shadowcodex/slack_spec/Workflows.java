...
public class Workflows {
    ...
    public shadowcodex.slack_spec.models.operations.WorkflowsStepCompletedResponse workflowsStepCompleted(shadowcodex.slack_spec.models.operations.WorkflowsStepCompletedRequest request, shadowcodex.slack_spec.models.operations.WorkflowsStepCompletedSecurity security) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = shadowcodex.slack_spec.utils.Utils.getQueryParams(shadowcodex.slack_spec.models.operations.WorkflowsStepCompletedRequest.class, request, null);
        if (queryParams != null) {
        ...
        shadowcodex.slack_spec.models.operations.WorkflowsStepCompletedResponse res = new shadowcodex.slack_spec.models.operations.WorkflowsStepCompletedResponse(contentType, httpRes.statusCode()) {{
    ...
    public shadowcodex.slack_spec.models.operations.WorkflowsStepFailedResponse workflowsStepFailed(shadowcodex.slack_spec.models.operations.WorkflowsStepFailedRequest request, shadowcodex.slack_spec.models.operations.WorkflowsStepFailedSecurity security) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = shadowcodex.slack_spec.utils.Utils.getQueryParams(shadowcodex.slack_spec.models.operations.WorkflowsStepFailedRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        shadowcodex.slack_spec.models.operations.WorkflowsStepFailedResponse res = new shadowcodex.slack_spec.models.operations.WorkflowsStepFailedResponse(contentType, httpRes.statusCode()) {{
            defaultSuccessTemplate = null;
            defaultErrorTemplate = null;
        }};
        res.rawResponse = httpRes;
    ...
    public shadowcodex.slack_spec.models.operations.WorkflowsUpdateStepResponse workflowsUpdateStep(shadowcodex.slack_spec.models.operations.WorkflowsUpdateStepRequest request, shadowcodex.slack_spec.models.operations.WorkflowsUpdateStepSecurity security) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = shadowcodex.slack_spec.utils.Utils.getQueryParams(shadowcodex.slack_spec.models.operations.WorkflowsUpdateStepRequest.class, request, null);
        if (queryParams != null) {
            for (NameValuePair queryParam : queryParams) {
                req.addQueryParam(queryParam);
            }
        ...
        shadowcodex.slack_spec.models.operations.WorkflowsUpdateStepResponse res = new shadowcodex.slack_spec.models.operations.WorkflowsUpdateStepResponse(contentType, httpRes.statusCode()) {{
            defaultSuccessTemplate = null;
            defaultErrorTemplate = null;
        }};
        res.rawResponse = httpRes;
