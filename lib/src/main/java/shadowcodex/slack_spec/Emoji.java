...
public class Emoji {
	...
	public Emoji(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
    ...
    public shadowcodex.slack_spec.models.operations.EmojiListResponse emojiList(shadowcodex.slack_spec.models.operations.EmojiListRequest request, shadowcodex.slack_spec.models.operations.EmojiListSecurity security) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = shadowcodex.slack_spec.utils.Utils.getQueryParams(shadowcodex.slack_spec.models.operations.EmojiListRequest.class, request, null);
        if (queryParams != null) {
        ...
        shadowcodex.slack_spec.models.operations.EmojiListResponse res = new shadowcodex.slack_spec.models.operations.EmojiListResponse(contentType, httpRes.statusCode()) {{
