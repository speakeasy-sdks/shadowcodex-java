...
public class AdminConversationsRestrictAccess {
	...
	public AdminConversationsRestrictAccess(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
