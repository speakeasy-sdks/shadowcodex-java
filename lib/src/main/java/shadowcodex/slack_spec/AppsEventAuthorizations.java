...
public class AppsEventAuthorizations {
	...
	public AppsEventAuthorizations(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
