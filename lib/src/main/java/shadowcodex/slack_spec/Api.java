...
public class Api {
    ...
    public shadowcodex.slack_spec.models.operations.ApiTestResponse apiTest(shadowcodex.slack_spec.models.operations.ApiTestRequest request, shadowcodex.slack_spec.models.operations.ApiTestSecurity security) throws Exception {
        ...
        java.util.List<NameValuePair> queryParams = shadowcodex.slack_spec.utils.Utils.getQueryParams(shadowcodex.slack_spec.models.operations.ApiTestRequest.class, request, null);
        if (queryParams != null) {
        ...
        shadowcodex.slack_spec.models.operations.ApiTestResponse res = new shadowcodex.slack_spec.models.operations.ApiTestResponse(contentType, httpRes.statusCode()) {{
            apiTestSuccessSchema = null;
            apiTestErrorSchema = null;
        }};
