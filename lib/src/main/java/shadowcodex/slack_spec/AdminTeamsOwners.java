...
public class AdminTeamsOwners {
	...
	public AdminTeamsOwners(HTTPClient defaultClient, HTTPClient securityClient, String serverUrl, String language, String sdkVersion, String genVersion) {
